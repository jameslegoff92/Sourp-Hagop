      ...
      fields: [
        {
          ...
          type: 'string',
          description: 'Hex color for the timeline progress bar (e.g., #007DC3)',
        ...
        },
        {
          ...
          title: 'Circle Color',
          type: 'string',
          description: 'Hex color for the timeline circles (e.g., #007DC3)',
          validation: Rule => Rule.regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/)
        },
        {
          name: 'dateTextColor',
          ...
          type: 'string',
          description: 'Hex color for the date text (e.g., #007DC3)',
          validation: Rule => Rule.regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/)
        }
      ]
    }
