  ...
  return (
    <Container>
      ...
      <ul>
        ...
        <li>
          <Text>
            <strong>Application</strong> refers to Sourp Hagop, the software
        ...
        <li>
          <Text>
            ...
            identified or identifiable inContaineridual.
          </Text>
        </li>
        <li>
          <Text>
        ...
        <li>
          <Text>
            ...
            third-party companies or inContaineriduals employed by the Company to
        ...
        <li>
          <Text>
            <strong>You</strong> means the inContaineridual accessing or using the
            Service, or the company, or other legal entity on behalf of which
            such inContaineridual is accessing or using the Service, as applicable.
          </Text>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <Text>
            ...
            to evaluate or conduct a merger, Containerestiture, restructuring,
      ...
      <ul>
        <li>
          ...
          <a
            href="https://sourp-hagop.vercel.app/confidentialite"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://sourp-hagop.vercel.app/confidentialite
          </a>
        </li>
      </ul>
    </Container>
