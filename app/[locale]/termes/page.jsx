...
const Terms = () => {
  return (
    <Container>
      ...
      <Text>Last updated: August 27, 2024</Text>
      <Text>
      ...
      <ul>
        <li>
          <Text>
            ...
            the Company downloaded by You on any electronic device, named Sourp
            Hagop
          </Text>
        </li>
        <li>
        ...
        <li>
          <Text>
            ...
            this Agreement) refers to Sourp Hagop.
          </Text>
        </li>
        <li>
          <Text>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://sourp-hagop.vercel.app/termes"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://sourp-hagop.vercel.app/termes
          </a>
        </li>
      </ul>
    </Container>
