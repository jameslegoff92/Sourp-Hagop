...
// Rental spaces page
export async function getRentalSpacesPage(locale) {
  return client.fetch(
    `*[_type == "rentalSpacesPage"][0] {
      ...
      "headerImageUrl": headerImage.asset->url,
        ...
        "imageUrl": image.asset->url,
        images[] { "url": asset->url },
        details[] { "label": ${localizedString('label')}, "value": ${localizedString('value')} }
      }
    }`,
    { locale },
    { next: { revalidate: 10 } }
...
// Admissions Page
export async function getAdmissionsPage(locale) {
  return client.fetch(
    `*[_type == "admissionsPage"][0] {
      "headerImageUrl": headerImage.asset->url,
      "headerText": ${localizedString('headerText')},
      "prescolairePrimaire": {
        "title": ${localizedString('prescolairePrimaireTitle')},
        "subtitle": ${localizedString('prescolairePrimaireSubtitle')},
        "text": ${localizedText('prescolairePrimaireText')},
        "buttonText": ${localizedString('prescolairePrimaireButtonText')},
        "link": prescolairePrimaireLink
      },
      "secondaire": {
        "title": ${localizedString('secondaireTitle')},
        "subtitle": ${localizedString('secondaireSubtitle')},
        "text": ${localizedText('secondaireText')},
        "buttonText": ${localizedString('secondaireButtonText')},
        "link": secondaireLink
      }
    }`,
    { locale },
...
// Tuition Fees Page
export async function getTuitionFeesPage(locale) {
  return client.fetch(
    `*[_type == "tuitionFeesPage"][0] {
      "headerImageUrl": headerImage.asset->url,
      "headerText": ${localizedString('headerText')},
      "introText": ${localizedText('introText')},
      "tableTitle": ${localizedString('tableTitle')},
      "prescolaireLabel": ${localizedString('prescolaireLabel')},
      "primaireLabel": ${localizedString('primaireLabel')},
      "secondaireLabel": ${localizedString('secondaireLabel')},
      fees[] {
